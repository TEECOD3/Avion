...
//           } size-10 flex text-gray-500 hover:text-white items-center justify-center transition`}
//           onClick={() => {
//             if (activeIndex > 0) {
...
//   return (
//     <div
//       className={`shrink-0 rounded-full transition-[scale] duration-300 delay-75 ${
//         index === activeIndex ? "bg-sky-500" : "bg-gray-700"
//       }`}
//       style={{
//         scale,
//         width: DOT_SIZE,
